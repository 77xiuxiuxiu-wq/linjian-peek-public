...
if [ ! -f "$DEBUG_KS" ]; then
    keytool -genkeypair -v \
        ...
        -dname "CN=Zhangxinchuang Public v0.3.4.3 Address Save Fix Debug"
fi
...
$BUILD_TOOLS/apksigner sign \
    ...
    --out "$PROJECT/Zhangxinchuang-public-v0.3.4.3.apk" \
    app.aligned.apk

echo ""
echo "=== Done ==="
echo "APK: $PROJECT/Zhangxinchuang-public-v0.3.4.3.apk"
ls -lh "$PROJECT/Zhangxinchuang-public-v0.3.4.3.apk"
