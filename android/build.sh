...
$BUILD_TOOLS/apksigner sign \
    ...
    --out "$PROJECT/Zhangxinchuang-public-v0.3.6.4.apk" \
    app.aligned.apk

echo "=== Verifying fixed public signature ==="
VERIFY_OUTPUT=$($BUILD_TOOLS/apksigner verify --verbose --print-certs "$PROJECT/Zhangxinchuang-public-v0.3.6.4.apk")
echo "$VERIFY_OUTPUT"
echo "$VERIFY_OUTPUT" | grep -qi "aea75c9b2b5f5c42d56b72d4a69a79a38e1c57f27db021017be8656bc8f002fb"

echo ""
echo "=== Done ==="
echo "APK: $PROJECT/Zhangxinchuang-public-v0.3.6.4.apk"
ls -lh "$PROJECT/Zhangxinchuang-public-v0.3.6.4.apk"
