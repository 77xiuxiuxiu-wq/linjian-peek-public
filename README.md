...
3. 构建成功后下载 `zhangxinchuang-public-v0.3.8.1-apk` artifact。

构建产物为：

```text
android/Zhangxinchuang-public-v0.3.8.1.apk
```

版本名 `0.3.8.1`，版本码 `30801`。
