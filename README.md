...
3. 构建成功后下载 `zhangxinchuang-public-v0.3.8.2-apk` artifact。

构建产物为：

```text
android/Zhangxinchuang-public-v0.3.8.2.apk
```

版本名 `0.3.8.2`，版本码 `30802`。
